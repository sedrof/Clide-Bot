...
@dataclass
class TradingConfig:
    """Trading configuration with all required fields."""
    max_positions: int
    max_buy_amount_sol: float
    min_balance_sol: float = 0.005  # Minimum balance to maintain
...
class ConfigManager:
            ...
            "properties": {
                ...
                "trading": {
                    ...
                    "properties": {
                        ...
                        "min_balance_sol": {"type": "number"},
                        "buy_amount_sol": {"type": "number"},
                        "copy_trade_percentage": {"type": "number"},
    ...
    def _load_settings(self) -> None:
        ...
        try:
            ...
            # Convert to BotSettings object with defaults for new fields
